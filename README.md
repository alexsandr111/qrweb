...
## Цветовая палитра
Все цвета должны браться из официального брендбука компании. Никаких других цветов в интерфейсе не использовать.
При необходимости расширения палитры — согласовывать с маркетинговым отделом.
